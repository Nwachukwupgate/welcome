        ...
        <>
            <div className="mt-28 max-w-screen-lg mx-auto" style={{marginTop:"110px"}}>
                ...
                <div className="mb-4 md:mb-0 w-full mx-auto relative">
                    ...
                    >
                        {postDetails?.category_id}
                    </a>
                    </div>

                    <img src={postDetails?.featured_image_link} className="w-full object-cover lg:rounded"/>
                </div>

                <div className="flex flex-col lg:flex-row lg:space-x-12">

                    <div className="px-4 lg:px-0 mt-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
                        <p className="pb-6" dangerouslySetInnerHTML={{__html: postDetails?.content}}/>
                    </div>
                    ...
                    <div className="p-4 border-t border-b md:border md:rounded">
                        ...
                        <div>
                            <p className="font-semibold text-gray-700 text-sm"> {postDetails?.authors_name} </p>
