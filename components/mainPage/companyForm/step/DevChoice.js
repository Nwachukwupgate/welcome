...
const handleSelectStack = async(e)=>{
  ...
  if(res.status == true){setFramework(res.data)}else{toast.error(res.error.message)}
                ...
                {state && state.map((items => (
                  <li className={styles.single_list} key={items.id}>
                    <label className={styles.list_label}>
                      ...
                      <input id="orange-radio" type="radio" value={items.id} name="colored-radio" class="w-4 h-4 hidden text-orange-500 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onChange={handleSelectStack} />
...
{showLanguages && (
  <div>
            <p className="text-[#001935] font-bold">Choose Languages</p>
            <div className={styles.main_container}>
              <ul className={styles.main_list}>
            ...
            <div className={styles.main_container}>
              <ul className={styles.main_list}>
                {price && price.map((items => (
                  <li className={styles.single_list} key={items.id}>
                    <label className={styles.list_label}>
                      {/* <input type="radio" name="" id={items.id} value={items.id} className={styles.inputType} /> */}
                      <input id="orange-radio" type="radio" value={items.id} name="colored-radio" class="w-4 h-4 hidden text-orange-500 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  />
