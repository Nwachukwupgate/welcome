    ...
    const[state, setState] = useState([
        {
            ...
            name: 'David Johnson',
            about: 'Full Stack maker & UI / UX Designer , love hip hop music Author of Building UI.',
        ...
        <div className="pt-20 pb-24 lg:pt-[7rem] mx-auto">
            <div className="lg:flex lg:items-center lg:space-x-14 mx-10">
                <div className="text-center flex flex-col items-center space-y-4 lg:items-start lg:text-left lg:space-y-10 lg:basis-3/5">
                    ...
                    <p className="text-gray-600">Recruiter? <span className="text-[#F49038]">HIRE DEVELOPERS</span></p>
                </div>

                
                    <div class="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-lg lg:basis-2/5">
                    ...
                    {state && state.map((items) => (
                        <div key={items.id}>
                        <img class="object-cover object-center w-full h-56" src={items.imgFile} alt="Developer" />
                        ...
                        <div class="flex items-center px-6 py-3 bg-gray-900">
                            ...
                            <h1 class="mx-3 text-lg font-semibold text-white">{items.availability}</h1>
                        </div>

                        <div class="px-6 py-4">
                            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{items.name}</h1>

                            <p class="py-2 text-gray-700 dark:text-gray-400">{items.about}</p>
                            ...
                            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                ...
                                <h1 class="px-2 text-sm">{items.profession}</h1>
                            </div>
                            ...
                            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                ...
                                <h1 class="px-2 text-sm">{items.country}</h1>
                            </div>
                            ...
                            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                ...
                                <h1 class="px-2 text-sm">Previously at: <span className="text-[#F49038]">{items.work}</span> </h1>
                            </div>
                        </div>
                        </div>
                        ))
